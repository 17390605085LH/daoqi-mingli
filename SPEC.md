...
- Step2新增: 面相照片上传（支持正面照 JPG/PNG）+ 手掌照片上传（支持掌心照）+ 五官特征复选框 + 手掌特征复选框（不上传照片也能做面相/手相分析）← 新增
- Step3: 出生地（自动补全）
- 验证：所有必填项，日期合理性
...
- 顶部：姓名 + 八字摘要 + 五行分布饼图
- 模块卡片：
  - ☯ 命盘总览（八字+十神详细卡+调候用神+道医体质+人生九阶段）← 扩充十神/喜用神
  - 🌿 五运六气（黄帝内经六气六步+个人影响+防病建议）← 新增
  - ⭐ 紫微斗数（十二宫星曜+四化+大限流年）
  - 👁 面相分析（十二宫+五官详析，支持照片上传或特征选择）← 完善
  - ✋ 手相分析（四大主线+掌丘+综合解读，支持照片或特征选择）← 完善
  - 🏠 风水布局（居家八卦方位+色彩+绿植，上传户型图解锁专属分析）← 完善
  - 📅 流年运势（当年流年+逐月趋势+十年大运）
  - 🔗 综合印证（四维体系交叉验证：八字×紫微×五运六气×道医体质，验证结论可靠性，输出命局总论与行动指南）← 新增
- 底部：根据付费等级解锁内容 + 付费升级 CTA

### 算法规范（对齐倪海厦天纪人纪地纪体系）
- 四柱十神全部重新校准：天干透干标注「透干」，地支藏干标注「藏支」，各附吉凶判断（吉/平/凶）标签
- 喜用神系统扩充：调候用神（四季各有优先级）+ 格局用神 + 忌神五行说明
- 大运计算按倪海厦体系：阳年男/阳年女顺行，阴年男/阴年女逆行
- 流年流月四化星（廉贞/紫微/天机/太阴等）完整排入各宫位
- 十神吉凶断语专业化：比肩/劫财/食神/伤官/偏财/正财/偏印/正印/七杀/正官各有独立描述
